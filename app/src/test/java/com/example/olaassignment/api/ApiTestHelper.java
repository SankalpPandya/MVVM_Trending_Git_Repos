...
public class ApiTestHelper<T> {
    ...
    public void pushResponse(String fileName) throws IOException {
        pushResponse(fileName, Collections.EMPTY_MAP);
    }


    private void pushResponse(String fileName, Map<String, String> headers) throws IOException {
        InputStream inputStream = ApiTestHelper.class.getClassLoader().
